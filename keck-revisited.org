...
#+BEGIN_SRC python :var data=porter-hei-tab4 :results file :noweb yes
  ...
  for wav in wavlist:
      ...
      ratio = em/em5876
      rat0 = ratio[i0]
      plt.semilogx(negrid, ratio/rat0, label="{}/5876: norm = {:.3f} ".format(wav, rat0))
  plt.legend(loc="lower right", fontsize="small")
  plt.xlabel("Density")
...
#+BEGIN_SRC python :var data=porter-hei-tab4 :results file :noweb yes
  ...
  <<tab4-to-datadict>>
  tab5dict = yaml.load(open("porter-hei-tab5.json"))
  wavlist = [4922, 5016, 5048, 5876]
  colors = "bgrc"
  Tgrid = np.linspace(5000.0, 15000.0)
  nelow, ne0, nehigh = 1.e3, 1.e4, 1.e5
  T0 = 1.e4
  ...
  for wav, c in zip(wavlist, colors):
      ...
      ratlow = emissivity(Tgrid, nelow, wav, datadict, tab5dict)/em6678
      rathigh = emissivity(Tgrid, nehigh, wav, datadict, tab5dict)/em6678
      rat0 = ratio[i0]
  ...
  plt.legend(loc="lower right", fontsize="small")
  plt.xlabel("Temperature")
  plt.ylabel("Emissivity ratio @ 1e4 (1e3, 1e5) pcc, normalized to value at 1e4 K")
  plt.ylim(0.0, None)
