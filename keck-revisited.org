...
** Stages for slit p79
1. Cosmetic defects - already done I think
2. Cosmic rays - I am not very happy with my spotless program, but I will try it
   #+name: spotless-p79
      #+BEGIN_SRC sh :results verbatim
     cd Keck1
     ...
     $SPOTLESS ${OBJ}b $COMMON_PARS --data-range 10 200 --threshold 200.0 
      ...
      Number of bad pixels: 343005 (14.545% of total)
      Number of distinct bad pixel objects found: 5525
      Number of objects skipped:  790
